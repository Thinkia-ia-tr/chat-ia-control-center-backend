...
const columns = [
  {
    ...
    cell: ({ original }: { original: Conversation }) => (
      <span className="block w-[35%] truncate">{original.title}</span>
    ),
  },
  {
    header: "Usuario",
    accessorKey: "user",
    cell: ({ original }: { original: Conversation }) => (
      <span className="block w-[35%] truncate">{original.user}</span>
    ),
  },
  {
    header: "Canal",
  ...
  },
  {
    ...
    accessorKey: "date",
    cell: ({ original }: { original: Conversation }) => (
      <span className="text-right block w-[15%] truncate">
