  ...
  const columns = [
    {
      ...
      className: "w-[40%]", // Updated column width to 40%
    },
    {
      header: "Conversación",
      ...
      className: "w-[50%]", // Keep column width at 50%
    },
    {
      header: "Fecha",
      ...
      className: "w-[10%] text-right", // Updated column width to 10% and keep text right-aligned
    },
  ];
